...
2.	The abundance of the round goby no effect on the abundance of native species 
...
1. First, linear regressions (M: is this the right term for it?) we will attempt to see if there is any relationship between the temperatures of different sites and the abundances of each species. 
