...
#Temperature Effects
Here we are examining how temperature affects each species both in terms of abudance and mass. 
We are using mixed models because we want to add a random effect of site to each one. 
```{r}
...
roundgoby.mixed.model.abundance <- lm(n ~ fishingTemperature_C, REML = F, data=fish.data.clean2.roundgoby)
roundgoby.mixed.model.mass <-lm(average_weight ~ fishingTemperature_C, REML = F, data=fish.data.clean2.roundgoby)
...
plot(roundgoby.mixed.model.abundance, 1:2)
plot(roundgoby.mixed.model.mass, 1:2)
```
```{r Temperature on Yellow Perch}
#making the mixed models
yellowperch.mixed.model.abundance <- lm(n ~ fishingTemperature_C, REML = F, data=fish.data.clean2.yellowperch)
yellowperch.mixed.model.mass <-lm(average_weight ~ fishingTemperature_C, REML = F, data=fish.data.clean2.yellowperch)
...
#Checking Assumptions
plot(yellowperch.mixed.model.abundance, 1:2)
plot(yellowperch.mixed.model.mass, 1:2)
```
```{r Temperature on Deepwater Sculpin}
#Making the mixed models
deepwatersculpin.mixed.model.abundance <- lm(n ~ fishingTemperature_C, REML = F, data=fish.data.clean2.deepwatersculpin)
deepwatersculpin.mixed.model.mass <-lm(average_weight ~ fishingTemperature_C, REML = F, data=fish.data.clean2.deepwatersculpin)
#plotting the results
...
#Checking Assumptions
plot(deepwatersculpin.mixed.model.abundance, 1:2)
plot(deepwatersculpin.mixed.model.mass, 1:2)
```
```{r Temperature on Trout Perch}
#making the models
troutperch.mixed.model.abundance <- lm(n ~ fishingTemperature_C, REML = F, data=fish.data.clean2.troutperch)
troutperch.mixed.model.mass <-lm(average_weight ~ fishingTemperature_C, REML = F, data=fish.data.clean2.troutperch)
#graphing the results
...
#Checking Assumptions
plot(troutperch.mixed.model.abundance, 1:2)
plot(troutperch.mixed.model.mass, 1:2)
```
```{r Temperature on Johnny Darter}
#making mixed models
johnnydarter.mixed.model.abundance <- lm(n ~ fishingTemperature_C, REML = F, data=fish.data.clean2.johnnydarter)
johnnydarter.mixed.model.mass <-lmer(average_weight ~ fishingTemperature_C, REML = F, data=fish.data.clean2.johnnydarter)
#plotting the results
...
#Checking Assumptions
plot(johnnydarter.mixed.model.abundance, 1:2)
plot(johnnydarter.mixed.model.mass, 1:2)
```
```{r Temperature on Lake Trout}
#Making Mixed Models
laketrout.mixed.model.abundance <- lmer(n ~ fishingTemperature_C, REML = F, data=fish.data.clean2.laketrout)
laketrout.mixed.model.mass <-lmer(average_weight ~ fishingTemperature_C, REML = F, data=fish.data.clean2.laketrout)
#plotting results
...
#Checking Assumptions
plot(laketrout.mixed.model.abundance, 1:2)
plot(laketrout.mixed.model.mass, 1:2)
```
```{r Temperature on Slimy Sculpin}
#making the models
slimysculpin.mixed.model.abundance <- lm(n ~ fishingTemperature_C, REML = F, data=fish.data.clean2.slimysculpin)
slimysculpin.mixed.model.mass <-lmer(average_weight ~ fishingTemperature_C, REML = F, data=fish.data.clean2.slimysculpin)
#graphing the results
...
#Checking Assumptions
plot(slimysculpin.mixed.model.abundance, 1:2)
plot(slimysculpin.mixed.model.mass, 1:2)
```
```{r Temperature on Threespine Stickleback}
#making the models
threespinestickleback.mixed.model.abundance <- lm(n ~ fishingTemperature_C, REML = F, data=fish.data.clean2.threespinestickleback)
threespinestickleback.mixed.model.mass <-lm(average_weight ~ fishingTemperature_C, REML = F, data=fish.data.clean2.threespinestickleback)
#plotting the results
...
#Checking Assumptions
plot(threespinestickleback.mixed.model.abundance, 1:2)
plot(threespinestickleback.mixed.model.mass, 1:2)
```
...
```{r RG on Lake Trout}
#making the model
laketrout.result <- lm(lake.trout~round.goby, data=fish.data.wider[which(fish.data.wider$lake.trout>0 | fish.data.wider$round.goby>0),]) 
...
#making the model
troutperch.result <- lm(trout.perch~round.goby  + (1|.cluster), data=fish.data.wider[which(fish.data.wider$trout.perch>0 | fish.data.wider$round.goby>0),])
...
#making the model
deepwatersculpin.result <- lm(deepwater.sculpin~round.goby, data=fish.data.wider[which(fish.data.wider$threespine.stickleback>0 | fish.data.wider$round.goby>0),])
